...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className='home__title'>EslamArafa
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <h3 className="home__subtitle">Front-End React 
        Developer</h3>
      <p className="home__description">Hi, I'm Eslam Arafa. A passionate Front-end React  Developer based in Ciro,Egyp.</p>
      </div>
  )
}
